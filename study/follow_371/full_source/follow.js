...
var optMenu = { delay:1, eenvoor:0, metro:1, keys:0, mark:0, mute:1, volgmod:6, chkmod:2, extract:1, 
    ...
    vol:50, nocur:0, rstmute:1, exact:0, nolyr:0, lus:0, lusstop:1, lncur: 1, tmng: 0, tmng2: 0,
    metmrk:0, ftyp:0, nocnt:0, scal:0, echo:1 };
var optRest = { staff:1, line:99, begin:0, btime:0, etime:0, // hebben (nog) geen menu equivalent
...
function toggleStart (stoppos, withCountIn = true) {
    ...
    if (startKnop.value == 'stop' || stoppos >= 0) {
        ...
        var nonChanges = MidiOutput.length;
...
function toggleMetro (withCountIn) {
    var cntTab = {'2/2':2, '3/2':3, '4/2':4, '2/4':4, '3/4':3, '4/4':4, '5/4':5, '6/8':6, '7/8':3, '9/8':9, '11/8':4, '12/8':4, '3/8': 4}
...
$(document).ready (function () {
    ...
    $('#tempo').change (function () {
        ...
        setAudSpeed ();
        MidiOutput.push("Tempo Changed to: " + kwartTempo.toString() + "\n");
    });
